...
const ProfilePhotoSelector = ({ image, setImage }) => {
    ...
    return (
        <div className='flex justify-center mb-3 md:mb-6'>
            ...
            {!image?(<div className='w-20 h-20 flex items-center justify-center bg-white rounded-full relative'>
              ...
              <button type='button' className='w-8 h-8 flex items-center justify-center bg-primary text-white rounded-full absolute -bottom-1 -right-1'  onClick={onChooseFile}>
                ...
                <button type='button' className='w-8 h-8 flex items-center justify-center bg-red-500 text-white rounded-full absolute -bottom-1 -right-1' onClick={handleImageRemove}>
                    <LuTrash/>
                </button>
