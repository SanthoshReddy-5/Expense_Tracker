  ...
  return (
    <div className='flex'>
      <div className="w-screen h-screen md:w-[50vw] flex items-center justify-center flex-col bg-black">
        <h2 className='text-3xl font-bold block md:hidden text-primary mb-3'>Track Pocket</h2>
        {children}
      </div>

      <div className='hidden md:block w-[50vw] h-screen bg-black py-16'>
        <div className='w-full h-full flex items-center justify-center flex-col border-l-2 border-slate-700'>
          <h2 className='text-primary text-5xl font-bold mb-2'>Track Pocket</h2>
